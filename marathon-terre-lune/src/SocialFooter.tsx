...
const URL_FACEBOOK = 'https://example.org/lunathon-social/facebook'
const URL_INSTAGRAM = 'https://example.org/lunathon-social/instagram'
const URL_WHATSAPP = 'https://example.org/lunathon-social/whatsapp'
...
export default function SocialFooter({ footer }: { footer: Copy['footer'] }) {
  return (
    <nav className="footer-social" aria-label={footer.socialNav}>
      <p className="footer-social-title">{footer.socialTitle}</p>
      <ul className="footer-social-list">
        <li>
          <a
            ...
            aria-label={footer.socialFacebook}
          >
            <IconFacebook />
          </a>
        </li>
        <li>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label={footer.socialInstagram}
          >
            <IconInstagram />
          </a>
        </li>
        <li>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            aria-label={footer.socialWhatsapp}
          >
            <IconWhatsapp />
          </a>
        </li>
      </ul>
      <p className="footer-social-hint">{footer.socialHint}</p>
    </nav>
  )
}
